...
export default function PaymentOptions({ paymentMethod, setPaymentMethod, onPrevStep, onConfirm, isSubmitting = false }) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex space-x-4">
        <button
          ...
          className="flex-1 py-4 border-2 border-gray-200 hover:border-primary hover:text-primary text-gray-600 rounded-xl text-base font-bold transition-all active:scale-98 text-center cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
        >
          Kembali
        </button>
        <button
          onClick={onConfirm}
          disabled={isSubmitting}
          className="flex-2 py-4 bg-accent hover:bg-accent-hover text-deep font-bold rounded-xl text-base shadow-lg hover:shadow-accent/20 transition-all duration-300 transform active:scale-98 text-center cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2"
        >
          {isSubmitting ? (
            <>
